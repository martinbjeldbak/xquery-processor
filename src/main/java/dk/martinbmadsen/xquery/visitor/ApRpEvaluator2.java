...
public class ApRpEvaluator2 {
    private XQueryBaseVisitor<IXQueryValue> visitor;
    private QueryContext qc;

    public ApRpEvaluator2(XQueryBaseVisitor<IXQueryValue> visitor, QueryContext qc) {
    ...
    public XQueryListValue evalRpSlash(@NotNull RuleContext ctx) {
        ...
        XQueryListValue x = (XQueryListValue)visitor.visit(node.left);
